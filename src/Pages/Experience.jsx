...
function TechStack() {
  ...
  const items = [
    ...
    { id: 11, category: 'Back End', name: 'Visual Basic', logo: process.env.PUBLIC_URL + "/Images/Tech Logos/vba.svg", size: "h-12 w-12", bg: "bg-oxf-hover", },
    { id: 12, category: 'Back End', name: 'MSSQL Server', logo: process.env.PUBLIC_URL + "/Images/Tech Logos/mssql.svg", size: "h-14 w-14", bg: "bg-b", },
